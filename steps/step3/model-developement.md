...
* Go to the **local file** tab and click **browse** to upload the notebook linked here as a local file: [Notebook](./notebook/agentic-rag.ipynb)
...
- Provide a unique name toyour development **AGENTIC_RAG_LC_DEV_NAME**
...
You have setup metric collection for the testing phase to evaluate your developement.
...
9. Here, Select **Project** created initially and Deployment space created  or if you have not created Click on **+New Space** and follow [Deployment Creation Steps](../../instructor/deploy-project.md) these steps for creating deployment space for **Testing** Deployment stage. Click on Save:
...
- [Agentic RAG Notebook](./notebook/agentic-rag.ipynb)
